...
<div class="container">
	<h1 class="page-header text-center">Collaborateurs CRUD </h1>
	<div class="row">
			...
			<table class="table table-bordered table-striped" style="margin-top:20px;">
				...
				<tbody>
					<?php
    					...
    					$db = $database->open();
						try{	
						    $sql = 'SELECT * FROM collaborateurs inner join departement on collaborateurs.departement_id=departement.id';
